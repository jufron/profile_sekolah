  ...
  <x-slot:body>
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Buat Jurnal Kelas</h6>
      </div>
      <div class="card-body">
        <form action="{{ route('jurnal.store') }}" method="post">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-2">
              ...
              <input type="text" class="form-control @error('jam_ke') is-invalid @enderror" value="{{ old('jam_ke') }}" id="jam_ke" name="jam_ke">
          ...
          <div class="form-group col-md-9">
            ...
            <textarea class="form-control @error('materi_pokok') is-invalid @enderror" id="materi_pokok" name="materi_pokok" rows="4" placeholder="Tulis materi disini">{{ old('materi_pokok') }}</textarea>
            @error('materi_pokok')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
          ...
          <div class="row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('sakit') is-invalid @enderror" value="{{ old('sakit') }}" id="sakit" name="sakit">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('ijin') is-invalid @enderror" value="{{ old('ijin') }}" id="ijin" name="ijin">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control @error('alpha') is-invalid @enderror" value="{{ old('alpha') }}" id="alpha" name="alpha">
